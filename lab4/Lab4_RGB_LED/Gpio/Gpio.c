...
void Gpio_ConfigPin(uint8 PortName, uint8 PinNum, uint8 PinMode, uint8 DefaultState)
{
	...
	case GPIO_A:
		...
		{
			GPIOA_INTYPER &= ~(0x03 << PinNum);
			GPIOA_INTYPER |= (DefaultState << PinNum);
		}
	...
	case GPIO_B:
		...
		else if (PinMode == GPIO_INPUT)
		{
			...
			GPIOB_INTYPER &= ~(0x01 << PinNum);
			GPIOB_INTYPER |= (DefaultState << PinNum);
		}
	...
	case GPIO_C:
		...
		else if (PinMode == GPIO_INPUT)
		{
			...
			GPIOC_INTYPER &= ~(0x01 << PinNum);
			GPIOC_INTYPER |= (DefaultState << PinNum);
		}
	...
	case GPIO_D:
		...
		else if (PinMode == GPIO_INPUT)
		{
			...
			GPIOD_INTYPER &= ~(0x01 << PinNum);
			GPIOD_INTYPER |= (DefaultState << PinNum);
		}
	...
	case GPIO_E:
		...
		else if (PinMode == GPIO_INPUT)
		{
			...
			GPIOE_INTYPER &= ~(0x01 << PinNum);
			GPIOE_INTYPER |= (DefaultState << PinNum);
		}
